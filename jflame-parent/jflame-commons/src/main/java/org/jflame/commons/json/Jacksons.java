...
public class Jacksons implements Jsons {
     ...
     */
    public Jacksons(boolean enableAutoTypeSupport) {
        Builder builder = JsonMapper.builder() // or different mapper for other format
        ...
        if (enableAutoTypeSupport) {
            objMapper = builder.activateDefaultTyping(LaissezFaireSubTypeValidator.instance,
