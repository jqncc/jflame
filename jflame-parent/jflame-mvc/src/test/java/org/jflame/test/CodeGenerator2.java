...
public class CodeGenerator2 {
    ...
    public static void main(String[] args) {
       ...
       // dsc.setUrl("jdbc:mysql://10.18.200.94:3306/zp_bss?characterEncoding=utf8");
        ...
        // 自定义 service 父类
        strategy.setSuperServiceClass("com.ghgcn.zpgo.service.ICrudService");
        // 自定义 service 实现类父类
        strategy.setSuperServiceImplClass("com.ghgcn.zpgo.service.impl.BaseServiceImpl");
        // 自定义 controller 父类
        strategy.setSuperControllerClass("com.ghgcn.zpgo.support.web.BaseController");
