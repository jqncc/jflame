...
public class NumberConvertor implements ICellValueConvertor<Number> {
    ...
    public NumberConvertor(Class<? extends Number> numberClass) {
        this.numberClass = numberClass;
    }

    @Override
    public Number convertFromExcel(Object cellValue, String fmt) throws ConvertException {
        if (cellValue == null) {
            return null;
        }
    ...
    @Override
    public String convertToExcel(Number value, String fmt) throws ConvertException {
    ...
    public String getConvertorName() {
        return CellConvertorEnum.NUMBER.toString();
    }
